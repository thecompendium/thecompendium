...
const Home: React.FC<HomeProps> = ({ onNavigate, publications, achievements, events, isAdmin }) => {
  ...
  return (
    <div className="pt-24 bg-[var(--primary-bg)] transition-colors">
      ...
      <section className="relative min-h-[90vh] flex items-center px-6 md:px-12 overflow-hidden bg-gradient-to-b from-[var(--primary-bg)] to-[var(--secondary-bg)]">
        <div className="relative z-10 max-w-7xl mx-auto text-center py-24">
          <span className="inline-block px-6 py-2 rounded-full bg-yellow-400/10 text-yellow-500 text-small font-black tracking-widest uppercase mb-10 animate-fadeInUp border border-yellow-400/20">
            The Publication Society of IARE
          </span>
      ...
      {/* DOODLE BACKGROUND WRAPPER - Starting from Featured Publications until footer */}
      <div className="relative overflow-hidden">
        {/* DOODLE PATTERN LAYER */}
        <div 
          className="absolute inset-0 z-0 pointer-events-none opacity-60 mix-blend-soft-light grayscale"
          style={{ 
        ...
        {/* VERY LIGHT YELLOW TINT OVERLAY (TRANSPARENT-BASE) */}
        <div className="absolute inset-0 z-0 bg-yellow-400/5 op-2 pointer-events-none" />
        ...
        <div className="relative z-10">
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {publications.length === 0 ? (
                  <div className="col-span-full py-24 text-center text-[var(--text-muted)] border border-dashed border-[var(--border-color)] rounded-[3rem] bg-black/40 backdrop-blur-sm">
                    <p className="text-body font-bold uppercase tracking-widest">Awaiting new publications...</p>
                  </div>
                ) : (
                  publications.slice(0, 4).map((pub) => (
                    <div key={pub.id} className="group glow-card rounded-[1.5rem] overflow-hidden flex flex-col h-full text-left bg-[#211f1e]/90 backdrop-blur-sm">
          ...
          <section className="py-32 px-6 border-t border-white/5">
            <div className="max-w-7xl mx-auto text-left">
              ...
              {events.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-20 text-center bg-black/20 rounded-3xl">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                  {events.slice(0, 4).map((event) => (
                      <div key={event.id} className="group glow-card rounded-[1.5rem] overflow-hidden flex flex-col h-full text-left bg-[#211f1e]/90 backdrop-blur-sm">
                        <div className="h-48 overflow-hidden relative">
            ...
            <div className="max-w-7xl mx-auto text-left">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                {achievements.length === 0 ? (
                  <div className="col-span-full py-20 text-center border-2 border-dashed border-white/10 rounded-3xl text-gray-500 uppercase text-xs font-black tracking-widest bg-black/20">Awaiting new milestones...</div>
                ) : (
                  achievements.slice(0, 4).map((ach) => (
                    <div key={ach.id} className="group glow-card rounded-[1.5rem] overflow-hidden flex flex-col h-full text-left bg-[#211f1e]/90 backdrop-blur-sm">
          ...
          <section className="py-32 px-6 border-t border-white/5">
            <div className="max-w-7xl mx-auto text-center">
              <h2 className="text-5xl font-bold serif-font mb-6 text-white">Key Facts</h2>
              <p className="text-lg text-gray-400 mb-20 font-light max-w-2xl mx-auto">A snapshot of our organization and impact</p>
              
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                {/* PUB COUNT CARD */}
                <div className="bg-[#010b1a] border border-white/5 rounded-2xl p-12 flex flex-col items-center justify-center aspect-[1.4/1] transition-all hover:bg-[#001529] group shadow-2xl">
                  ...
                  <p className="text-gray-400 text-xs font-bold uppercase tracking-[0.2em] text-center leading-relaxed">Publishing student work</p>
                </div>
                ...
                <div className="bg-[#010b1a] border border-white/5 rounded-2xl p-12 flex flex-col items-center justify-center aspect-[1.4/1] transition-all hover:bg-[#001529] group shadow-2xl">
                  ...
                  <span className="text-5xl font-bold text-white mb-3">{stats.articles}</span>
                  <p className="text-gray-400 text-xs font-bold uppercase tracking-[0.2em] text-center leading-relaxed">Articles published</p>
                </div>
                ...
                <div className="bg-[#010b1a] border border-white/5 rounded-2xl p-12 flex flex-col items-center justify-center aspect-[1.4/1] transition-all hover:bg-[#001529] group shadow-2xl">
                  ...
                  <span className="text-5xl font-bold text-white mb-3">{stats.editions}</span>
                  <p className="text-gray-400 text-xs font-bold uppercase tracking-[0.2em] text-center leading-relaxed">News Editions</p>
                </div>
                ...
                <div className="bg-[#010b1a] border border-white/5 rounded-2xl p-12 flex flex-col items-center justify-center aspect-[1.4/1] transition-all hover:bg-[#001529] group shadow-2xl">
                  ...
                  {isAdmin ? (
                    <input className="bg-transparent text-5xl font-bold text-white text-center w-full focus:outline-none border-b border-white/10 mb-2" value={membersCount} onChange={e => { setMembersCount(e.target.value); setHasUnsavedChanges(true); }} />
                  ) : (
                    <span className="text-5xl font-bold text-white mb-3">{membersCount}</span>
                  )}
                  <p className="text-gray-400 text-xs font-bold uppercase tracking-[0.2em] text-center leading-relaxed">Active members</p>
                </div>
              </div>
            </div>
          </section>
          ...
          <section className="py-32 px-6 border-t border-white/5">
            <div className="max-w-7xl mx-auto">
              <div className="bg-[#211f1e]/95 rounded-[2.5rem] p-12 md:p-20 border border-white/5 shadow-3xl text-left backdrop-blur-md">
